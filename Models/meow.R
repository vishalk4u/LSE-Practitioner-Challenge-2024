...
tickers <- c("VALE", "PBR", "ITUB", "ABCB", "EC", "AMX", "CX","BVN","TV","YPF","MELI")
...
debt_data <- data.frame(
  symbol= c("VALE","PBR","ITUB","ABCB","EC","AMX","CX","BVN","TV","YPF","MELI"),  # Specify symbols for each company
  debt_2008 = c(17535,10421,33812.5,120,739,4966.9,603,750,1107,749.5,1.5),
  debt_2009 = c(10325,24622,14988.75,22.1345,1342.87,3895,7569.34,75.275,1603.005,288.04,3),
  debt_2010 = c(11437.5,30266,24192.785,42.882,2075.93,11898.5,7808.36,90,1855.07,206.785,0.09),
  debt_2011 = c(11437,36408,16461.28,31.1345,2191.74,12650.5,9532.64,90,2259.48,564.995,0.068),  
  debt_2012 = c(14226,4285,43526.6,21.1345,3210.672,15528.5,7912.565,86.74,2174.485,1335.84,0.03),
  debt_2013 = c(14722.5,53154,42748.595,125.019,5784.48,17760,7340.57,111.5135,2521.325,2125.295,1.245),
  debt_2014 = c(14557,60137,41838.65,72.103,8464.915,18547,8212.215,156.677,3213.59,2232.055,141.092), 
  debt_2015 = c(13173.5,55780,38285.23,54.437,9729.94,16378.5,7975.62,160.158,3562.091,4239.609,147.171),
  debt_2016 = c(13831,54298.5,33217.315,288.274,31262.285,15078.5,6994.48,276.116,3634.44,4318.177,150.97),
  debt_2017 = c(10393,51124.5,35720.145,168.052,28802.5,16327.5,5031.845,274.546,3432.827,4582.155,156.09),  
  debt_2018 = c(7231.5,40335,31278.5,120.4805,27234.17,13786,5429,270.448,3306.739,4796.973,301.114),
  debt_2019 = c(7996,38457.5,35362.73,763.134,23258.87,13135.5,5173.5,152.998,3342.31,4761.4345,315.67),
  debt_2020 = c(8652,32827,28551.27,274.75,27175.46,12038.5,5063.5,253.283,3047.34,3917.4035,430.43)
)
...
#Try to get Zhou model to work for 2 companies then extend to all companies (for the win)
# if doesn't work then do ST226 Week 8.
